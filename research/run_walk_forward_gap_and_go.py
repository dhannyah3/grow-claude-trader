...
FOLDS_PATH = OUTPUT_DIRECTORY / (
    "gap_and_go_walk_forward_folds.csv"
)

SYMBOL_RESULTS_PATH = OUTPUT_DIRECTORY / (
    "gap_and_go_walk_forward_symbol_results.csv"
)

PARAMETER_HISTORY_PATH = OUTPUT_DIRECTORY / (
    "gap_and_go_walk_forward_parameter_history.csv"
)

OVERALL_SUMMARY_PATH = OUTPUT_DIRECTORY / (
    "gap_and_go_walk_forward_overall_summary.csv"
)
...
def build_strategy(
    **parameters: Any,
    ...
    """
    Create one Gap and Go strategy instance.

    The optimizer controls the parameters supplied through
    ``parameters``. Opening-range duration, maximum RSI,
    and trading times remain fixed.
    """
...
def print_fold_results(
    ...
    print()
    print("=" * 150)
    print("GAP AND GO WALK-FORWARD OUT-OF-SAMPLE FOLDS")
    print("=" * 150)
...
def print_parameter_history(
    ...
    print()
    print("=" * 150)
    print("GAP AND GO TRAINING-WINDOW PARAMETER HISTORY")
    print("=" * 150)
...
def print_overall_summary(
    ...
    print()
    print("=" * 90)
    print("OVERALL GAP AND GO WALK-FORWARD RESULT")
    print("=" * 90)
...
def main() -> None:
    """
    Configure and run Gap and Go walk-forward validation.
    """
    ...
    #
    # 2 × 2 × 2 × 2 × 2
    # = 32 configurations per training fold.
    #
    # Opening-range duration remains fixed at 15 minutes.
    parameter_grid = {
    "minimum_gap_percent": [
        0.2,
        0.3,
    ...
    validator = WalkForwardValidator(
        ...
        # Use the same windows as the Donchian test so that
        # the two strategies can be compared fairly.
        train_days=120,
        test_days=30,
        step_days=30,
        ...
        # Gap strategies naturally produce fewer trades than
        # continuous breakout strategies.
